...
exports.crearItemLista = crearItemLista;
exports.activarBotonesCompra = activarBotonesCompra;
// LocalStorage
...
function activarBotonesCompra(lista = []) {
    ...
    for (let index = 0; index < listaBtnCompraCarrito.length; index++) {
        listaBtnCompraCarrito[index].addEventListener('click', function () {
            ...
            (0, functions_localstorage_js_1.crearDatoLS)('lista-cache-carrito-productos', listaInicial);
        });
    }
    // let resultado = null;
    // for (let index = 0; index < listaBtnCompraCarrito.length; index++) {
