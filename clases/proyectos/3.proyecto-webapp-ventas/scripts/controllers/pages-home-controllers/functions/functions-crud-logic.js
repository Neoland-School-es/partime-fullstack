...
const functions_crud_inline_js_1 = require("./functions-crud-inline.js");
...
const functions_element_list_scripts_js_1 = require("./functions-element-list-scripts.js");
function imprimirLista(lista = []) {
    const contenedorLista = document.querySelector('#ContenedorLista .list-group');
    contenedorLista.innerHTML = '';
    for (let i = 0; i < lista.length; i++) {
        const itemLista = (0, functions_element_list_scripts_js_1.crearItemLista)(i, lista[i]);
        contenedorLista.appendChild(itemLista);
    }
    (0, functions_crud_inline_js_1.inlineActualizarProducto)(lista);
    (0, functions_crud_inline_js_1.inlineEliminarProducto)(lista);
    (0, functions_crud_modal_js_1.modalActualizarProducto)(lista);
    (0, functions_crud_modal_js_1.modalEliminarProducto)(lista);
    (0, functions_element_list_scripts_js_1.activarBotonesCompra)(lista);
}
